#
#   OrangeFox Recovery Project - vendorsetup.sh for Lenovo TB132FU
#
FDEVICE="TB132FU"
...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
        ...
        export FOX_TARGET_DEVICES="TB132FU,p11_pro_2gen"
